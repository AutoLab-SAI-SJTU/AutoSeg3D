...
def create_indoor_info_file(data_path,
    ...
    assert pkl_prefix in ['scannet', 'scannet_sv', 'scannet_mv', 'scannet200', 'scannet200_sv', 'scannet200_mv',
                          'scenenn', 'scenenn_mv', 'scenenn_mv_fast', '3rscan', '3rscan_mv', '3rscan_mv_fast'], \
    ...
    elif pkl_prefix == 'scenenn_mv' or pkl_prefix == 'scenenn_mv_fast':
    ...
    elif pkl_prefix == '3rscan_mv' or pkl_prefix == '3rscan_mv_fast':
