...
if __name__ == '__main__':
    ...
    elif args.dataset in ('scenenn','scenenn_mv', 'scenenn_mv_fast'):
        scenenn_data_prep(
            root_path=args.root_path,
            info_prefix=args.extra_tag,
            out_dir=args.out_dir,
            workers=args.workers)
    elif args.dataset in ('3rscan', '3rscan_mv', '3rscan_mv_fast'):
...
# python tools/create_data.py 3rscan_mv_fast --root-path ./data/3RScan-mv_fast --out-dir ./data/3RScan-mv_fast --extra-tag 3rscan_mv_fast