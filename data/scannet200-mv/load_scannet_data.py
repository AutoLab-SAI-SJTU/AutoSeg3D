...
def export(mesh_file,
    ...
    if scannet200:
        ...
        label_map = scannet_utils.read_label_mapping( # 读取类别到ID的映射
            label_map_file, label_from='raw_category', label_to='nyu40id')

    mesh_vertices = scannet_utils.read_mesh_vertices_rgb(mesh_file) # [N, 6] xyzrgb

    # Load scene axis alignment matrix 传感器配置，包括相机内参、外参以及每个传感器的图像尺寸、帧数等信息
    ...
    # perform global alignment of mesh vertices 进行坐标系转换
